  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 text-center p-8">
      ...
      <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
        The content you are looking for is no longer available. However, feel
        free to explore other sections of our website.
      </p>
      <Link href="/">
...
export default async function Page({ params }: { params: QueryParams }) {
  ...
  return (
    <>
      ...
      {initial?.data?.schemaMarkup && (
        <SchemaMarkup schema={initial?.data?.schemaMarkup} />
      )}
    </>
  );
}
