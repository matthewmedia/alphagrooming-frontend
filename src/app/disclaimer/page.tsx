          ...
          <div className="bg-white text-center rounded">
            ...
            <ul>
              <li>
                ...
                in this Disclaimer) refers to AlphaGrooming, 15973 Baxter Creek
                Drive.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to AlphaGrooming, accessible
                from{" "}
                <a
                  href="https://www.alphagrooming.org"
            ...
            <ul>
              <li>By email: alphagroominghub@gmail.com</li>
            </ul>
          </div>
        </div>
      </Layout>
