      ...
      <Layout style={{ backgroundImage: `url('/background.png')` }}>
        ...
        >
          <div className="bg-white text-center rounded">
            ...
            <p>Welcome to AlpgaGrooming!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of AlpahGrooming&apos;s Website, located at
              https://www.alphagrooming.org.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use AlpgaGrooming if you do not
            ...
            <p>
              ...
              &lsquo;Client&lsquo;, &lsquo;You&lsquo; and &lsquo;Your&lsquo; refers to you, the person log on this
              website and compliant to the Company&apos;s terms and conditions. &lsquo;The
              Company&lsquo;, &lsquo;Ourselves&lsquo;, &lsquo;We&lsquo;, &lsquo;Our&lsquo; and &lsquo;Us&lsquo;, refers to our
              Company. &lsquo;Party&lsquo;, &lsquo;Parties&lsquo;, or &lsquo;Us&lsquo;, refers to both the Client
            ...
            <p>
              We employ the use of cookies. By accessing AlpgaGrooming, you
              agreed to use cookies in agreement with the AlpahGrooming&apos;s
              Privacy Policy.{""}
            </p>
            ...
            <p>
              Unless otherwise stated, AlpahGrooming and/or its licensors own
              the intellectual property rights for all material on
              AlpgaGrooming. All intellectual property rights are reserved. You
              may access this from AlpgaGrooming for your own personal use
              subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from AlpgaGrooming</li>
              <li>Sell, rent or sub-license material from AlpgaGrooming</li>
              <li>Reproduce, duplicate or copy material from AlpgaGrooming</li>
              <li>Redistribute content from AlpgaGrooming</li>
            </ul>
            ...
            <p>
              ...
              AlpahGrooming does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of AlpahGrooming,its agents and/or
              ...
              applicable laws, AlpahGrooming shall not be liable for the
            ...
            <p>
              AlpahGrooming reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant AlpahGrooming a non-exclusive license to use,
            ...
            <p>
              ...
              AlpahGrooming; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to AlpahGrooming. Please include your name,
            ...
            <p>
              No use of AlpahGrooming&apos;s logo or other artwork will be allowed
