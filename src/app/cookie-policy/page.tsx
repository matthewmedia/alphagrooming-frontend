      ...
      <Layout style={{ backgroundImage: `url('/background.png')` }}>
        ...
        >
          <div className="bg-white text-center rounded">
            <h1>Cookie Policy for AlpgaGrooming</h1>

            <p>
              This is the Cookie Policy for AlpgaGrooming, accessible from
            ...
            <p>
              ...
              or &lsquo;break&lsquo; certain elements of the sites functionality.
            </p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  including; * Twitter * Facebook * Instagram * Pinterest *
                  Quora will set cookies through our site which may be used to
            ...
            <ul>
              <li>Email: alphagroominghub@gmail.com</li>
            </ul>
          </div>
        </div>
      </Layout>
