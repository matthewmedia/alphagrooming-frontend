...
const HeadMeta = ({
  ...
  return (
    <Head>
      ...
      <meta
        property="og:title"
        content={metaTitle ? metaTitle : "AlphaGrooming"}
      />
      <meta
      ...
      <meta
        ...
        content={metAlt ? metAlt : `ImageAlphaGrooming Logo Dark`}
      />
      <meta property="og:image:width" content="1600" />
      <meta property="og:image:height" content="1490" />
      <meta
        name="keywords"
        content="men, skincare , hairstyle , routine, fragrances , perfume"
      />
      <meta
        name="robots"
      ...
      <meta
        ...
        content={
          metaDescription
            ? metaDescription
            : `Welcome to Alpha Grooming, the premier resource for all men's skincare, fragrances! At Alpha Grooming, we believe that every man deserves to look and feel his best, which is why we've put together an extensive collection of expert techniques, innovative routines, and useful recommendations to assist you in putting your best face forward.That said, grooming is only one aspect of expressing your alpha identity. We're here to educate you, inspire confidence, and help you up your groom!`
        }
      />
      <meta
        name="viewport"
      ...
      <script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-6WV7PV1X9C"
      ></script>
    </Head>
  );
};
